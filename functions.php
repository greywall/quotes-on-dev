...
function qod_scripts() {
	...
	// wp_enqueue_style( 'qod-font-awesome', ' the url for font awesome 4 and google fonts url ');
	// wp_enqueue_style( 'qod-google-font', ' the url for font awesome 4 and google fonts url ');
